...
function Fetch_the_newest_file_ta2m(newest_folder, str_postfix) {
    return new Promise(function(resolve, reject){
		...
		}).catch(function(error) { console.log('00011发生错误！', error);})  	 ; 
    });
}    
...
function Fetch_the_newest_file(newest_folder, str_postfix) {
    return new Promise(function(resolve, reject){
		...
		}).catch(function(error) { console.log('00012发生错误！', error);})  	 ; 
    });
}    
/////////////////////////////////////////////////////  
/////////////////////////////////////////////////////    
...
function Conbine_object_fcst_1_15dy_cnweather(object_variables1, object_variables2) {
    return new Promise(function(resolve, reject){
		...
		console.log(list_ta2m_max1+"  "+list_ta2m_min1)
		console.log(list_ta2m_max2+"  "+list_ta2m_min2)
		for(var iiiii = 0; iiiii < list_yyyy_mm_dd_hh1.length; iiiii++)  { 
			...
			json_element.ta2m 	  = ( parseInt(list_ta2m_max1[iiiii]) + parseInt(list_ta2m_min1[iiiii]) ) / 2  +"℃";
		...
		for(var iiiii = 0; iiiii < list_yyyy_mm_dd_hh2.length; iiiii++)  { 
			...
			json_element.ta2m = ( parseInt(list_ta2m_max2[iiiii]) + parseInt(list_ta2m_min2[iiiii]) ) / 2  +"℃";
...
function onRequest(request, response) { 
		...
		response.setHeader ("Access-Control-Allow-Headers", "Referer,Accept,Origin,User-Agent,token,Host,Authorization,Content-Type,DNT,Cache-Control,X-Mx-ReqToken,X-Requested-With");
