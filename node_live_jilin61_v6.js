...
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
function Read_fcst_7dy_ww_for_lliii(result_str, lliii_min_dis, now_lon, now_lat) {
    return new Promise(function(resolve, reject){ 
		var list_town_name=[];
...
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
function Choose_the_nearest_lliii(str_meta_nmc, now_lon, now_lat) {
    return new Promise(function(resolve, reject){ 
		...
		for(var jjjj = 1; jjjj <list_fullname.length-1; jjjj++)  { 
		...
		console.log("        "+dis0+"   "+idx_mininum+"  "+list_fullname[idx_mininum])
		return resolve(list_lliii[idx_mininum])
    });
} 
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
 		...
 		if (url.parse(request.url, true).pathname != "/"){
			...
			if (now_category=="/"){   ///!isInteger(cnt/2) chrom 请求两次数据，postman和其他浏览器请求一次数据
				...
				if(now_category=='/fcst2'){  
					...
					dir_inuse=dir_fcst_nmc;	
					Readin_str_from_file_txt222(meta_nmc ,'GBK')								 	 
					.then(function(str_meta_nmc)  {   
								return Choose_the_nearest_lliii(str_meta_nmc, now_lon, now_lat);
					}).then(function(lliii_min_dis1)  {  
							lliii_min_dis=lliii_min_dis1;
						return Fetch_the_newest_folder(dir_inuse)
								...
								return Readin_str_from_file_txt222(newest_file ,'GBK')
					}).then(function(result_str)  {  
								return Read_fcst_7dy_ww_for_lliii(result_str, lliii_min_dis, now_lon, now_lat);
					}).then(function(object_variables)  {   
								return Convert_object_fcst_array_to_output(now_variables, object_variables)
